//Fri Jul 05 2024 09:35:35 GMT+0000 (Coordinated Universal Time)
...
function _0x5ef8e6(_0x10da9f, _0x13c00a, _0x19032a = "") {
  ...
  _0x19032a && (_0x3a7d0b.body = _0x19032a, _0x3a7d0b.headers["Content-Type"] = "application/json", _0x3a7d0b.headers["Content-Length"] = _0x3a7d0b.body ? _0x3a7d0b.body.length : 0);
  return _0x3a7d0b;
}
  ...
  return new class {
    ...
    send(_0x490fa9, _0x1e4f53, _0xd64859 = () => {}) {
      ...
      if (this.isSurge() || this.isLoon()) {
        ...
        if (_0x490fa9 == "get") {
          delete _0x4bf958.data;
        }
        $axios(_0x4bf958).then(_0x230bdb => {
          const {
              status: _0x56a267,
              request: _0x2ba5f0,
              headers: _0x130e94,
